...
![Graduation Project Poster](https://raw.githubusercontent.com/dal-arc/dal-arc/main/graduation-project-poster.png)

## Overview

This graduation project focuses on climate data analysis and model evaluation for daily precipitation downscaling. The work analyzes spatiotemporal precipitation behavior, evaluates emulator model outputs, and applies interpretability analysis to examine whether learned spatial patterns are meaningful from a climatological perspective.
...
- MSE
- RMSE
- Climate-specific metrics for extreme-event representation and climatic realism

## Project Focus

This project combines climate data analysis, emulator model evaluation, and Explainable AI to support more reliable and interpretable precipitation downscaling for regional forecasting.
